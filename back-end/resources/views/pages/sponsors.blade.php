                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center">
                    <div class="card border-0 shadow-lg">
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary btn-block mt-3" onclick="showPaymentForm({{ $sponsor->id }})">Sponsorizza</button>
                            <!-- Form per la selezione dell'appartamento e il pagamento Braintree (inizialmente nascosto) -->
                            <form action="{{ route('applySponsor', ['sponsor_id' => $sponsor->id]) }}" method="POST" class="apply-sponsor-form d-none" id="apply-sponsor-form-{{ $sponsor->id }}">
                                @csrf
