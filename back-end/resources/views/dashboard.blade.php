...
.modal {
    ...
    z-index: 1; /* Posiziona il modal sopra il resto del contenuto */
    left: 0;
    top: 0;
    width: 100%;
    height: 100%;
    overflow: auto; /* Abilita lo scorrimento se il contenuto del modal è troppo lungo */
    background-color: rgba(0, 0, 0, 0.4); /* Sfondo scuro leggermente trasparente */
}

.modal-content {
    background-color: #fefefe;
    margin: 15% auto; /* Posiziona il modal al centro dello schermo */
    padding: 20px;
